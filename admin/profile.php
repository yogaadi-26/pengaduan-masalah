            ...
            <div class="card">
              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="col-sm-12">
                    <a href="admin.php?page=edit-profile&id_user=<?= $profil['id_user']; ?>" class="btn btn-primary mr-2">Edit Profile</a>
                    <a href="admin.php?page=change-pass&id_user=<?= $profil['id_user']; ?>" class="btn btn-secondary">Change Password</a>
                  </div>
              </div>
            </div>
